...
# custom logging
import logging
logger = logging.getLogger("NetWatcher2")
logger.parent = 0
logger.setLevel(logging.INFO)
config = deluge.configmanager.ConfigManager("netwatcher2.conf",
                                                         DEFAULT_PREFS)
...
class Core(CorePluginBase):
    ...
    def enable(self):
        self.config = deluge.configmanager.ConfigManager("netwatcher2.conf",
                                                         DEFAULT_PREFS)
        ...
        if self.config["custom_log"]:
            ...
            file_path = os.path.join(self.config["log_dir"], 'netwatcher2_log.txt')
